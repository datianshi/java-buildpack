...
module JavaBuildpack
  module Container
    ...
    def tcserver
      ...
      @droplet.sandbox + 'tcserver'
    end

    # The Tomcat +lib+ directory
    #
    # @return [Pathname] the Tomcat +lib+ directory
    def tcserver_tomcat_lib
      puts "tcserver : #{tcserver}"
      @droplet.sandbox + 'tcserver/lib'
    end

    # The Tomcat +webapps+ directory
    #
    # @return [Pathname] the Tomcat +webapps+ directory
    def tcserver_tomcat_webapps
      puts "tcserver : #{tcserver}"
      @droplet.sandbox + 'tcserver/webapps'
    end
